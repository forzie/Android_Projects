...
*/
        ...
        if(cursor != null) {
            while(cursor.isAfterLast()==false) {
                ...
                price.setText("Price "+offernewprice+" Rs Savings "+(cursor.getDouble(cursor
                        .getColumnIndex(OfferTable.OFFER_OLDPRICE))-cursor.getDouble(cursor
                        .getColumnIndex(OfferTable.OFFER_NEWPRICE)))+" Rs");
                ...
                if( cursor.isAfterLast()==false) {
                    ...
                    price2.setText("Price "+offernewprice2+" Rs Savings "+(cursor.getDouble(cursor
                            .getColumnIndex(OfferTable.OFFER_OLDPRICE))-cursor.getDouble(cursor
                            .getColumnIndex(OfferTable.OFFER_NEWPRICE)))+" Rs");
                    ...
                    date2.setTextColor(getResources().getColor(R.color.primary));
